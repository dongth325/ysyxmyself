...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000000 00000 00000 000 00000 11100 11", ecall  , N, s->dnpc = isa_raise_intr(11, s->pc)); // 替换 EVENT_YIELD
  //INSTPAT("0011000 00010 00000 000 00000 11100 11", mret   , R, s->dnpc = SR(MEPC)); // 如果 MEPC 未定义，请定义或处理
