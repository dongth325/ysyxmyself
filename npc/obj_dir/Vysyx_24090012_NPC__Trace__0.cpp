...
void Vysyx_24090012_NPC___024root__trace_chg_0_sub_0(Vysyx_24090012_NPC___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelfRef.__Vm_traceActivity[1U])) {
        ...
        bufp->chgCData(oldp+2,(vlSelfRef.ysyx_24090012_NPC__DOT__rd),5);
        bufp->chgCData(oldp+3,(vlSelfRef.ysyx_24090012_NPC__DOT__opcode),7);
        bufp->chgCData(oldp+4,(vlSelfRef.ysyx_24090012_NPC__DOT__func3),3);
        bufp->chgCData(oldp+5,(vlSelfRef.ysyx_24090012_NPC__DOT__func7),7);
        bufp->chgIData(oldp+6,(vlSelfRef.ysyx_24090012_NPC__DOT__imm),32);
        bufp->chgCData(oldp+7,(vlSelfRef.ysyx_24090012_NPC__DOT__alu_op),6);
        bufp->chgBit(oldp+8,(((0x13U == (IData)(vlSelfRef.ysyx_24090012_NPC__DOT__opcode)) 
                                       ...
                                       | ((0x6fU == (IData)(vlSelfRef.ysyx_24090012_NPC__DOT__opcode)) 
                                          | ((0x67U 
                                             ...
                                             | ((0x33U 
                                                ...
                                                | (3U 
                                                   == (IData)(vlSelfRef.ysyx_24090012_NPC__DOT__opcode)))))))))));
        bufp->chgSData(oldp+9,(vlSelfRef.ysyx_24090012_NPC__DOT__csr_addr),12);
        bufp->chgBit(oldp+10,(vlSelfRef.ysyx_24090012_NPC__DOT__is_ecall));
        bufp->chgBit(oldp+11,(vlSelfRef.ysyx_24090012_NPC__DOT__is_mret));
    }
    if (VL_UNLIKELY(vlSelfRef.__Vm_traceActivity[2U])) {
        bufp->chgIData(oldp+12,(vlSelfRef.ysyx_24090012_NPC__DOT__result),32);
        bufp->chgIData(oldp+13,(vlSelfRef.ysyx_24090012_NPC__DOT__next_pc),32);
        bufp->chgIData(oldp+14,(vlSelfRef.ysyx_24090012_NPC__DOT__csr_wdata),32);
    }
    if (VL_UNLIKELY(vlSelfRef.__Vm_traceActivity[3U])) {
        bufp->chgSData(oldp+15,(vlSelfRef.ysyx_24090012_NPC__DOT__csr_addr1),12);
        bufp->chgIData(oldp+16,(vlSelfRef.ysyx_24090012_NPC__DOT__csr_wdata1),32);
        bufp->chgBit(oldp+17,(vlSelfRef.ysyx_24090012_NPC__DOT__csr_wen1));
        bufp->chgSData(oldp+18,(vlSelfRef.ysyx_24090012_NPC__DOT__csr_addr2),12);
        bufp->chgIData(oldp+19,(vlSelfRef.ysyx_24090012_NPC__DOT__csr_wdata2),32);
        bufp->chgBit(oldp+20,(vlSelfRef.ysyx_24090012_NPC__DOT__csr_wen2));
