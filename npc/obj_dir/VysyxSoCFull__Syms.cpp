    ...
    , TOP____024unit{this, Verilated::catName(namep, "$unit")}
{
    ...
    __Vscope_ysyxSoCFull__asic__lgpio__mgpio.configure(this, name(), "ysyxSoCFull.asic.lgpio.mgpio", "mgpio", "<null>", -9, VerilatedScope::SCOPE_OTHER);
    ...
    for (int __Vfinal = 0; __Vfinal < 2; ++__Vfinal) {
        ...
        __Vscope_ysyxSoCFull__asic__cpu__cpu__exu.exportInsert(__Vfinal, "get_exu_count", (void*)(&VysyxSoCFull___024root____Vdpiexp_ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__exu__DOT__get_exu_count_TOP));
        __Vscope_ysyxSoCFull__asic__cpu__cpu__idu.exportInsert(__Vfinal, "get_branch_inst_count", (void*)(&VysyxSoCFull___024root____Vdpiexp_ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__idu__DOT__get_branch_inst_count_TOP));
        __Vscope_ysyxSoCFull__asic__cpu__cpu__idu.exportInsert(__Vfinal, "get_compute_inst_count", (void*)(&VysyxSoCFull___024root____Vdpiexp_ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__idu__DOT__get_compute_inst_count_TOP));
        __Vscope_ysyxSoCFull__asic__cpu__cpu__idu.exportInsert(__Vfinal, "get_csr_inst_count", (void*)(&VysyxSoCFull___024root____Vdpiexp_ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__idu__DOT__get_csr_inst_count_TOP));
        __Vscope_ysyxSoCFull__asic__cpu__cpu__idu.exportInsert(__Vfinal, "get_idu_count", (void*)(&VysyxSoCFull___024root____Vdpiexp_ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__idu__DOT__get_idu_count_TOP));
        ...
        __Vscope_ysyxSoCFull__asic__cpu__cpu__idu.exportInsert(__Vfinal, "get_jump_inst_count", (void*)(&VysyxSoCFull___024root____Vdpiexp_ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu__DOT__idu__DOT__get_jump_inst_count_TOP));
        ...
        __Vscope_ysyxSoCFull__asic__lgpio__mgpio.exportInsert(__Vfinal, "get_switch_value", (void*)(&VysyxSoCFull___024root____Vdpiexp_ysyxSoCFull__DOT__asic__DOT__lgpio__DOT__mgpio__DOT__get_switch_value_TOP));
    }
}
