...
VL_ATTR_COLD void VysyxSoCFull___024root___ctor_var_reset(VysyxSoCFull___024root* vlSelf) {
    ...
    vlSelf->ysyxSoCFull__DOT__asic__DOT__apbdelay_delayer__DOT__ready_shift = VL_RAND_RESET_I(5);
    VL_RAND_RESET_W(160, vlSelf->ysyxSoCFull__DOT__asic__DOT__apbdelay_delayer__DOT__data_shift);
    vlSelf->ysyxSoCFull__DOT__asic__DOT__apbdelay_delayer__DOT__error_shift = VL_RAND_RESET_I(5);
    vlSelf->ysyxSoCFull__DOT__asic__DOT__apbdelay_delayer__DOT__unnamedblk1__DOT__i = 0;
    vlSelf->ysyxSoCFull__DOT__asic__DOT__apbdelay_delayer__DOT____Vlvbound_h1f3a1e84__0 = VL_RAND_RESET_I(1);
    vlSelf->ysyxSoCFull__DOT__asic__DOT__apbdelay_delayer__DOT____Vlvbound_he868cc31__0 = VL_RAND_RESET_I(32);
    vlSelf->ysyxSoCFull__DOT__asic__DOT__apbdelay_delayer__DOT____Vlvbound_hd5566499__0 = VL_RAND_RESET_I(1);
