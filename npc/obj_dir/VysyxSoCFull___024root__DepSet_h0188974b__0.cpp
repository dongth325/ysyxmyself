...
#endif
            VL_FATAL_MT("../ysyxSoC/build/ysyxSoCFull.v", 5829, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("../ysyxSoC/build/ysyxSoCFull.v", 5829, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("../ysyxSoC/build/ysyxSoCFull.v", 5829, "", "Active region did not converge.");
            }
